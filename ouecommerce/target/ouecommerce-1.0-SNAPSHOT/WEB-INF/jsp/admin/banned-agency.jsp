<%-- 
    Document   : banned-agency
    Created on : 31 Aug 2022, 02:03:16
    Author     : thu.nv2512
--%>
...
<div class="row col-md-12 col-12">
    <div class="container py-5">
        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4 text-uppercase">Banned Agency</p>
        <c:if test="${listAgencyBanned.size() == 0}">
        ...
        <c:forEach items="${listAgencyBanned}" var="agency">
            <div id="banned-agency-${agency.agencyID}" class="row justify-content-center mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                    <div class="d-flex flex-column mt-2">
                                        ...
                                        <button id="btn-view-detail-agency-stats2-${agency.agencyID}" onclick="redirectToUrl('<c:url value="/admin/agency-stats/${agency.agencyID}"/>')" class="btn btn-outline-dark btn-sm mt-2" type="button">View Stats</button> 
                                        <div style="display: none" id="sp-wait-unban-agency-${agency.agencyID}" class="spinner-border"></div>
                                        <button onclick="unbanAgency('<c:url value="/api/unban-agency/${agency.agencyID}"/>', ${agency.agencyID}, this)"class="btn btn-outline-dark btn-sm mt-2" type="button">Un ban Agency</button> 
                                    </div>
                                </div>
                            </div>
                        </div>
