<%-- 
    Document   : agency-stats
    Created on : 30 Aug 2022, 23:52:02
    Author     : thu.nv2512
--%>
...
<div class="container py-5">
    <p class="text-center h3 fw-bold mb-2 mx-1 mx-md-4 mt-2 text-uppercase">General Statistics</p>
</div>
<div class="col-12 col-md-12 row">
    ...
    <div class="col-md-4 col-4">
        ...
        <div class="col-6 col-md-6">
            <canvas id="chart-top-seller-admin" width="400" height="400"></canvas>
        </div>
        <div class="col-6 col-md-6">
            <table class="table">
                <thead>
    ...
    <div class="col-12 col-md-12 row">
        ...
        <div class="col-6 col-md-6">
            <canvas id="chart-stats-by-category-admin" width="400" height="400"></canvas>
        </div>
        <div class="col-6 col-md-6">
            <table class="table">
                <thead>
    ...
    <script>
        ...
        <c:forEach items="${statsByCategory}" var="cate">
                    ...
                    loadChartTopSellerInAdmin(labelTopSeller, dataTopSeller);
                    loadChartStatsCategoryInAdmin(labelStatsCate, dataStatsCate);
                };
    </script>
