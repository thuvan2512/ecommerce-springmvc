...
<div class="row col-md-12 col-12">
    <div class="container py-5">
        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4 text-uppercase">Published Sale Post</p>
        <c:if test="${listPostPublished.size() == 0}">
        ...
        <c:forEach items="${listPostPublished}" var="post">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <h6 class="text-dark fw-bold">Created date: <span class="fw-bold"><fmt:formatDate pattern = "dd/MM/yyyy" value = "${post.createdDate}" /></span></h6>
                                    <h6 class="text-dark fw-bold">State: <span class="fw-bold">Published</span></h6>
                                    <h6 class="text-dark fw-bold"><span class="fw-bold">${post.itemSet.size()}</span> Item(s)</h6>
                                    <h6 class="text-dark fw-bold"><span class="fw-bold">${post.picturePostSet.size()}</span> Picture(s)</h6>
                                </div>
                                <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                    <div class="d-flex flex-column mt-2">
                                        ...
                                        <button onclick="unpublishSalePost('<c:url value="/api/unpublish-salepost/${post.postID}"/>',${post.postID})" class="btn btn-outline-dark btn-sm mt-2" type="button">Stop selling</button>
